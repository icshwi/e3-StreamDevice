...
# Author  : jhlee
# email   : @esss.se
# Date    : generated by 2017Nov30-1313-38CET
# version : 0.0.0 
#
# template file is generated by prepare_module.bash with 72ac1424fd0607f71f5b202b860b0bf9c8108572
#
...
.PHONY: env $(E3_ENV_NAME) $(EPICS_MODULE_SRC_PATH) git-submodule-sync init help help2 build clean install uninstall conf rebuild checkout
